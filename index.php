        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $sql = "SELECT post.post_id, post.title, post.post_img, post.post_date, post.description, post.author, post.category, category.category_name, user.username FROM post 
